...
Main.prototype = {
	...
	,setupGUI: function() {
		...
		this.shaderGUI.add(this,"displayMode",{ Full_Effect : "Full Effect", Processed_Video_Feed : "Processed Video Feed", Feed_And_Effect_Mix : "Feed And Effect Mix", Effect_And_Passthrough_Mix : "Effect And Passthrough Mix", Distance_Field : "Distance Field", Video_Feed : "Video Feed"}).listen();
		...
		dat_ShaderGUI.generate(this.shaderGUI,"BOX_DENOISER",this.denoisePass.uniforms);
		dat_ShaderGUI.generate(this.shaderGUI,"TEXTURE_MIXER",this.mixerPass.uniforms);
		var f = dat_ShaderGUI.generate(this.shaderGUI,"GAUSSIAN_BLUR",sdf_shaders_GaussianBlur.uniforms);
		f.add(this,"blurIterations").listen().min(1).max(60);
		this.shaderGUI.add({ f : function() {
			window.open("https://github.com/Tw1ddle/Amsterdam-Light-Festival-2016","_blank");
		}},"f").name("View Source");
	}

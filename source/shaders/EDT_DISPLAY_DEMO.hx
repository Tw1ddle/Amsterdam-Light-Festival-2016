...
class EDT_DISPLAY_DEMO {
	public static var uniforms = {
		...
		stepThreshold0: { type: "f", value: 0.0, min: 0.0, max: 0.001 },
		stepThreshold1: { type: "f", value: 0.0, min: 0.0, max: 0.005 },
		stepThreshold2: { type: "f", value: 0.0, min: 0.0, max: 0.005 },
		stepThreshold3: { type: "f", value: 0.0, min: 0.0, max: 0.005 },
		stepThreshold4: { type: "f", value: 0.0, min: 0.0, max: 0.005 },

...
Main.prototype = {
	...
	,setupGUI: function() {
		...
		this.shaderGUI.add(this,"displayMode",{ Full_Effect : "Full Effect", Processed_Webcam_Feed : "Processed Webcam Feed", Feed_And_Effect_Mix : "Feed And Effect Mix", Webcam_Feed : "Webcam Feed"}).listen();

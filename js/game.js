...
Main.prototype = {
	onWindowLoaded: function() {
		...
		this.videoImageElement = window.document.getElementById("monitor");
		this.videoImageCanvas = window.document.getElementById("videoImage");
		this.videoImageContext = this.videoImageCanvas.getContext("2d");
		this.videoImageContext.fillStyle = "#000000";
		this.videoImageContext.fillRect(0,0,this.videoImageCanvas.width,this.videoImageCanvas.height);
		this.videoTexture = new THREE.Texture(this.videoImageCanvas);
		this.videoTexture.minFilter = THREE.LinearFilter;
		this.videoTexture.magFilter = THREE.LinearFilter;
		var material = new THREE.MeshBasicMaterial({ map : this.videoTexture, overdraw : 1, side : THREE.DoubleSide});
	...
	,animate: function(time) {
		...
		if(this.videoImageElement.readyState == 4) {
			this.videoImageContext.drawImage(this.videoImageElement,0,0,this.videoImageCanvas.width,this.videoImageCanvas.height);
			if(this.videoTexture != null) this.videoTexture.needsUpdate = true;
		}
